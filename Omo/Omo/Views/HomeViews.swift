    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 32) {
                ...
                .contentShape(RoundedRectangle(cornerRadius: OmoTheme.radius, style: .continuous))
                .onTapGesture {
...
struct AddKnowledgeView: View {
    ...
    private var inputStatusColor: Color {
        chapterInput.validationError == .invalidLinkFormat ? OmoTheme.error : OmoTheme.textSoft
    }
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    SBCard {
                        ...
                        Divider().background(OmoTheme.lineSoft)
                        HStack {
                    ...
                    PrimaryButton(
                        ...
                        #if DEBUG
                        print("[Omo] AddKnowledgeView tapped generate. inputCount=\(submittedInput.count), canSubmit=\(chapterInput.canSubmit), target=\(store.submissionTargetTitle)")
                        #endif
                        dismissInput()
                        Task {
                    ...
                    HStack {
                        ...
                        Button {
                            ...
                            Label(store.localized("add.dismiss_keyboard"), systemImage: "keyboard.chevron.compact.down")
                                ...
                                .shadow(color: OmoTheme.shadow.opacity(0.08), radius: 10, y: 4)
                        }
                        .buttonStyle(.plain)
                    }
                    .padding(.horizontal, 24)
